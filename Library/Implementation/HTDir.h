...
/*
   ...
   This module is implemented by HTDir.c, and it is a part of the  W3C Reference Library.
...
What Should the Listings Look Like?
   ...
   If the HT_DS_DES is set then the Descriptionfield is added as the last column in the
   listing.  File descriptions are queried from the HTDescript module. Make a full mask by
   adding/oring the following flags:
...
/*
  ...
  LENGTH OF FILENAMES AND DESCRIPTIONS
   ...
   The module automatically ajusts the width of the directory listing as a function of the
   file name. The width can flows dynamically between an upper and a lower limit.  The
...
The Directory Object
   ...
   The directory object handles the generation of a directory listing. It is a bit like a
  ...
  WIDTH OF FILE NAMES
   ...
   The module automatically ajusts the width of the directory listing as a function of the
   file name. The width can flows dynamically between an upper and a lower limit.
...
/*
  ...
  ADD A LINE TO THE LIST
   ...
   This function accepts a directory line. "data" and "size", and "description" can all be
   NULL. Returns YES if OK, else NO
